...
$idioma = $_POST['i'];
 ...
 $sql = $ini->consulta("select url_amg_lang.titulo as titulo, archivo.archivo as archivo, url_amg.id as id from url_amg_lang inner join url_amg on url_amg_lang.id_url_amg = url_amg.id inner join archivo on url_amg.plantilla = archivo.id where seccion = '32'");
...
$sql = $ini->consulta("select * from archivo where id = '9' or id = '11'"); while($reg = $ini->fetch_object($sql)){
