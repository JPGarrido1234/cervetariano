...
$idioma = $_POST['i'];
 ...
 $sql = $ini->consulta("select url_amg_lang.titulo as titulo, url_amg.id as id from url_amg_lang inner join url_amg on url_amg_lang.id_url_amg = url_amg.id where seccion = '51'");
