...
; (function ($) {
    ...
    $.liveEdit = function (element, options) {
        ...
        plugin.init = function () {
            ...
            var arrSnippetItems = [["FormattedText", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_texto.htm',800,458,'Insertar formas de texto');", "Formas de textos"],            
                ["Icons", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_icono.htm',800,458,'Insertar Iconos');", "Iconos"],
                ["LabelsBadges", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_etiqueta.htm',650,423,'Insertar etiquetas e insignias');", "Etiquetas"],
                ["Alerts", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_alerta.htm',670,355,'Insertar alertas');", "Alertas"],
                ["LinkButtons", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_enlace.htm',810,410,'Insertar botones con enlaces');", "Enlaces decorados"],            
                ["ImageGallery", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_imagen.htm',750,400,'Insertar imagen/galeria');", "Imagenes decoradas"],
                ["Video", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_video.htm',500,590,'Insertar Video');", "Video (Youtube, Vimeo)"],
                ["Layout", "modalDialog('" + _editorobj.dialogPath + "ventanas/bootstrap_columna.htm',800,453,'Insertar diseño de cuadricula');", "Columnas"]
            ]  
            ...
            for (var i = 0; i < plugin.settings.groups.length; i++) {
                ...
                for (var j = 0; j < tmp[2].length; j++) {
                    if(tmp[2][j]=='Snippets'){
                        _editorobj.arrCustomButtons.push(["Snippets", "", "Formatos", "btnSnippets.gif", 37, arrSnippetItems]);
                    }
                }                
            }
