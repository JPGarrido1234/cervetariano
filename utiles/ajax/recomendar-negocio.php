...
$sql = $ini->consulta("insert into recomendar_ngc_sr (id_negocio,id_usuario) value ('".$_POST['id_negocio']."','".$id_amg_usu."')");  }else{ ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	Debes iniciar sesión para poder recomendar a un negocio.
      </div>
