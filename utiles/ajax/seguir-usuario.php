...
$sql = $ini->consulta("insert into seguir_sr_sr (id_seguido,id_seguidor) value ('".$_POST['id_usuario']."','".$id_amg_usu."')");  }else{ ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	Debes iniciar sesión para poder seguir a un usuario.
      </div>
