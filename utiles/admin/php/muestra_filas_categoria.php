...
$adaux = "../../php/"; include("../../php/iniciar.php"); include('../../php/admin.php'); $ad = new admin(); $seccion = 33;
        ...
        switch($_POST['admin_lis_usu_php_op']){
            ...
            case 3:{ $sql = $ini->consulta("select * from url_amg where seccion = '".$seccion."'");  while($reg = $ini->fetch_object($sql)){
                     if(isset($_POST['chusu'.$reg->id])){ 
                        ...
                        $ssql = $ini->consulta("delete from union_ngc_ctgr where id_categoria = '".$reg->id."'");
                    } } }; break;
            ...
            case 6:{ 
                ...
                $ssql = $ini->consulta("delete from union_ngc_ctgr where id_categoria = '".$_POST['admin_lis_usu_php_id']."'");
            }; break;
        }
}
