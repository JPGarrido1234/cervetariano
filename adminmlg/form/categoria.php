...
switch($_POST['modo']){
	case 'crear' :{
		...
		$sql = $ini->consulta("insert into url_amg (seccion,subsecc,plantilla,fecha,thumbs,activo) values ('33','0','8','".$fecha."','".$imagen."','".$activo."')");
		...
		$sql = $ini->consulta("insert into categoria (id_categoria,id_padre) value ('".$ultimoid."','".$_POST['categoria']."')");
	...
	case 'modificar' :{
		...
		$sql = $ini->consulta("update categoria set id_padre = '".$_POST['categoria']."' where id_categoria = '".$_POST['id']."'");
