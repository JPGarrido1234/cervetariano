...
<div class="panel-heading"> <i class="fa fa-file-text-o fa-fw"></i> Contenido</div>
    <div class="panel-body">
        <div class="form-group row">
            <input type="text" class="form-control" id="idname" name="name" value="" required="required" />
...
<div class="panel panel-warning">
<div class="panel-heading"> <i class="fa fa-calendar fa-fw"></i> Fecha</div>
    <div class="panel-body">
        <div class="form-group row">
            <input type="date" class="form-control" id="idfecha" name="fecha" value="" required="required" />
        </div>
    </div>
</div>
...
<div class="panel-heading"> <i class="fa fa-rss fa-fw"></i> SEO</div>
    <div class="panel-body">
        <h3>General</h3>
        <div class="form-group row">
            <input type="text" class="form-control" id="idurl" name="url" value="" />
            <label for="idurl">Url amigable</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idmtit" name="mtit" value="" />
            <label for="idmtit">Meta título</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idmdes" name="mdes" value="" />
            <label for="idmdes">Meta descripción</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idmkey" name="mkey" value="" />
        ...
        <div class="form-group row">
            <div class="input__row uploader">
              ...
              <input type="file" class="upload" id="file_1f" name="imgf" />
            </div>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idurlf" name="urlf" value="" />
            <label for="idurlf">Url imagen</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idtitf" name="titf" value="" />
            <label for="idtitf">Título</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="iddesf" name="desf" value="" />
        ...
        <div class="form-group row">
            <div class="input__row uploader">
              ...
              <input type="file" class="upload" id="file_1t" name="imgt" />
            </div>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idurlt" name="urlt" value="" />
            <label for="idurlt">Url imagen</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idtitt" name="titt" value="" />
            <label for="idtitt">Título</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="iddest" name="dest" value="" />
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        ...
        <div class="form-group row">
            <input type="text" class="form-control" id="idtimg" name="timg" />
            <label for="idtimg">Título</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control" id="idaimg" name="aimg" />
...
$sql = $ini->consulta("select * from url_amg where seccion = '23'"); if($ini->num_rows($sql) > 0){ 
if(isset($_GET['npagt'])){ $paginar = $_GET['npagt']; }else{ $paginar = 10; } $desde = 0;
if($_GET['pagina'] != ""){ $desde = ($_GET['pagina']-1)*$paginar; } $hasta = $paginar; 
$sql = $ini->consulta("select * from url_amg where seccion = '23' order by fecha desc"); $contador = $ini->num_rows($sql);
?>
...
function marcartodos(){ 
    if(document.getElementById("seltodos").checked == true){ 
        <?php $sql = $ini->consulta("select * from url_amg where seccion = '23' order by fecha desc limit ".$desde.",".$hasta);  while($reg = $ini->fetch_object($sql)){ ?>
...
<?php $sql = $ini->consulta("select * from url_amg inner join url_amg_lang on url_amg.id = url_amg_lang.id_url_amg where lang = '".$idioma."' and url_amg.seccion = '23' order by fecha desc limit ".$desde.",".$hasta); while($reg=$ini->fetch_object($sql)){ ?>
    <tr>
        <td>
            <div class="icheckbox_flat-blue" aria-checked="false" aria-disabled="false" style="position:relative">
...
<script>
    typeof $.typeahead === 'function' && $.typeahead({
        ...
        source: { ajax: function (query) { return { type: "POST", url: "<?php echo $urlppal; ?>utiles/buscador/auto-completar_eventos.php", dataType: "json",
...
$sqle = $ini->consulta("select fecha from eventos where id_evento = '".$_GET['id']."'"); $rege = $ini->fetch_object($sqle);
?>
...
<div class="panel-heading"> <i class="fa fa-rss fa-fw"></i> SEO</div>
    <div class="panel-body">
        ...
        <div class="form-group row">
            <input type="text" class="form-control<?php if($redes->titt){ ?> relleno<?php } ?>" id="idtitt" name="titt" value="<?php echo $redes->titt; ?>" />
            <label for="idtitt">Título:</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control<?php if($redes->dest){ ?> relleno<?php } ?>" id="iddest" name="dest" value="<?php echo $redes->dest; ?>" />
            <label for="iddest">Descripción:</label>
        </div>
    </div>
</div>
...
<div class="panel-heading"> <i class="fa fa-calendar fa-fw"></i> Fecha</div>
    <div class="panel-body">
        <div class="form-group row">
            <input type="date" class="form-control" id="idfecha" name="fecha" value="<?php echo $rege->fecha; ?>" required="required" />
        </div>
    </div>
</div>
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
        ...
        <div class="form-group row">
            <input type="text" class="form-control<?php if($titalt[0] != ""){ echo " relleno"; } ?>" id="idtimg" name="timg" value="<?php echo $titalt[0]; ?>" />
            <label for="idtimg">Título:</label>
        </div>
        <div class="form-group row">
            <input type="text" class="form-control<?php if($titalt[1] != ""){ echo " relleno"; } ?>" id="idaimg" name="aimg" value="<?php echo $titalt[1]; ?>" />
            <label for="idaimg">Alt:</label>
        </div>
    </div>
</div>
